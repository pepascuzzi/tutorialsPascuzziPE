...
This tutorial builds on the functions to show you how to write a function that will extract the top 50 highest expressing genes for all 53 tissues in the GTEx data.  
