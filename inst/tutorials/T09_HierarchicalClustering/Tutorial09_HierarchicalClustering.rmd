...
The `iris` data set in the **datasets** package, contains four variables for flower organs for three iris species.  Let's see if we can use hierarchical clustering to group the observations by species using only these variables.  
...
There are 50 observations each for the iris species *Setosa**, **Versicolor**, **Virginica**.  

In this tutorial, you will learn how hierarchical clustering works by studying the steps to an actual data set like `iris`. 
