...
The code used to originally import the data into R is shown below.  This chunk cannot be run.  
...
For a large file, it can be important to examine the last rows of the data (use a negative integers with `slice`).  If the file is sorted in any way, unusual values may occur in these last rows.  
